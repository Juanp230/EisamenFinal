...
## RESUMEN
En el Taller de Servicios Internos del centro penitenciario, los internos pueden solicitar trabajos de impresión y encuadernado para recoger el mismo día. El sistema registra el nombre y número de celda del solicitante y permite crear un pedido con impresiones en blanco y negro, impresiones a color y encuadernados, aplicando precios por volumen cuando corresponda. Una vez ingresadas las cantidades (que no pueden ser menores ni iguales a cero), el sistema calcula los subtotales, suma el total bruto y aplica un único beneficio: un 10% de descuento si hay al menos un encuadernado y el total de impresiones es igual o superior a 30, o en su defecto un 5% si el total bruto supera los $40.000; de no cumplirse ninguna condición, no se aplica descuento. Tras confirmar el pedido, este queda bloqueado y se muestra un resumen final con los subtotales, el total bruto, el descuento aplicado y el total a pagar, sin gestionar inventarios ni pagos reales.
